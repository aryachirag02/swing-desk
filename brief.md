...
**Index F&O (dip-buy):** NIFTY 50 RSI2=38 → below 200DMA — stand aside · BANK NIFTY RSI2=38 → no setup
...
THEME: India electric SUV adoption + affordability play, similar to MSIL and TATAMOTORS leading EV transition.

FUNDAMENTALS:  April 2026 domestic sales 51,902 units (+17% YoY) ,  nearly debt-free with 36.8% ROE  — backed by volume growth.

VERDICT: Mixed — margin pressure from commodities, post-IPO valuation re-rating risk.

CALL: BUY-WORTHY — real volume traction and EV positioning, but not stretched yet.
...
**Leading sectors:** Healthcare (+13.8%) · Diversified (+12.4%) · Realty (+11.1%) · Textiles (+9.9%)
...
- **ABB** (Capital Goods · Large cap) — score 94, Breakout — new 20-day high on 6.5× volume. Entry ₹7667.5 · Stop ₹7097.1 · Target ₹8808.3 · Risk/sh ₹570.4 · 📅 results 2026-07-30 — inside holding window
...
- **BHEL** (Capital Goods · Mid cap) — score 90, Breakout — new 20-day high on 3.2× volume. Entry ₹435.4 · Stop ₹397.0 · Target ₹512.2 · Risk/sh ₹38.4 · 📅 results 2026-07-30 — inside holding window
